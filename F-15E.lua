...
CFT_Rack_Bombs("{CFT_L_GBU_31V3B_x_2}",	"GBU-31(V)3/B",		"weapons.bombs.GBU_31_V_3B",	981.0,	0.00170,	CFTL_2StaL, "GBU31_V_3B_BLU109",	"GBU-31V3B.png")
...
CFT_Rack_Bombs("{CFT_R_GBU_31V3B_x_2}",	"GBU-31(V)3/B",		"weapons.bombs.GBU_31_V_3B",	981.0,	0.00170,	CFTR_2StaL,	"GBU31_V_3B_BLU109",	"GBU-31V3B.png")
...
dofile(current_mod_path..'/IFF.lua')
...
----------------------------------------------------
	...
	panelRadio = {
		[1] = {
            ...
            channels = {
                [1] = { name = _("Channel 1"),		default = 266.0, modulation = _("FM"), connect = true}, -- Mozdok ATC
                [2] = { name = _("Channel 2"),		default = 264.0, modulation = _("FM")},	-- min. water : 135.0, 264.0
                [3] = { name = _("Channel 3"),		default = 265.0, modulation = _("FM")},	-- nalchik : 136.0, 265.0
                [4] = { name = _("Channel 4"),		default = 256.0, modulation = _("FM")},	-- sochi : 127.0, 256.0
                [5] = { name = _("Channel 5"),		default = 254.0, modulation = _("FM")},	-- maykop : 125.0, 254.0
                [6] = { name = _("Channel 6"),		default = 250.0, modulation = _("FM")},	-- anapa : 121.0, 250.0
                [7] = { name = _("Channel 7"),		default = 270.0, modulation = _("FM")},	-- beslan : 141.0, 270.0
                [8] = { name = _("Channel 8"),		default = 257.0, modulation = _("FM")},	-- krasnodar-pashk. : 128.0, 257.0
                [9] = { name = _("Channel 9"),		default = 255.0, modulation = _("FM")},	-- gelenjik : 126.0, 255.0
                [10] = { name = _("Channel 10"),	default = 262.0, modulation = _("FM")},	-- kabuleti : 133.0, 262.0
                [11] = { name = _("Channel 11"),	default = 259.0, modulation = _("FM")},	-- gudauta : 130.0, 259.0
                [12] = { name = _("Channel 12"),	default = 268.0, modulation = _("FM")},	-- soginlug : 139.0, 268.0
                [13] = { name = _("Channel 13"),	default = 269.0, modulation = _("FM")},	-- vaziani : 140.0, 269.0
                [14] = { name = _("Channel 14"),	default = 260.0, modulation = _("FM")},	-- batumi : 131.0, 260.0
                [15] = { name = _("Channel 15"),	default = 263.0, modulation = _("FM")},	-- kutaisi : 134.0, 263.0
                [16] = { name = _("Channel 16"),	default = 261.0, modulation = _("FM")},	-- senaki : 132.0, 261.0
                [17] = { name = _("Channel 17"),	default = 267.0, modulation = _("FM")},	-- lochini : 138.0, 267.0
                [18] = { name = _("Channel 18"),	default = 251.0, modulation = _("FM")},	-- krasnodar-center : 122.0, 251.0
                [19] = { name = _("Channel 19"),	default = 253.0, modulation = _("FM")},	-- krymsk : 124.0, 253.0
                [20] = { name = _("Channel 20"),	default = 266.0, modulation = _("FM")}, -- mozdok : 137.0, 266.0
            }
		},
		[2] = {
            ...
            channels = {
                ...
                [2] = { name = _("Channel 2"),		default = 257.8, modulation = _("FM")},	-- Kobuleti ATC
                ...
                [5] = { name = _("Channel 5"),		default = 344.0, modulation = _("FM")},	-- Ground Control Approach / Search
                [6] = { name = _("Channel 6"),		default = 385.0, modulation = _("FM")},	-- Ground Control Approach / Final
                [7] = { name = _("Channel 7"),		default = 130.0, modulation = _("AM")},	-- Gudauta ATC
                [8] = { name = _("Channel 8"),		default = 385.4, modulation = _("FM")},	-- Ground Control Approach
	...
	passivCounterm = {
		CMDS_Edit = true,
		SingleChargeTotal = 30000,
		-- RR-170
		chaff = {default = 15000, increment = 30, chargeSz = 1},
		-- MJU-7
		flare = {default = 15000, increment = 15, chargeSz = 2}
	},
  ...
  shells = {
        ...
        pylon(2, 0, -0.155000, -0.343000, -2.944000, { arg = 308, arg_value = 0, connector = "Pylon2",  use_full_connector_position = true, DisplayName = "2", droppable_shape	= "f-15E_Pylon_2", },
            {
				...
				{   CLSID =  "{D8F2C90B-887B-4B9E-9FE2-996BC9E9AF03}", Type = 1, forbidden = Pylon2_MK80s_restrictions },
				{   CLSID =  "{B06DD79A-F21E-4EB9-BD9D-AB3844618C9C}", Type = 1, forbidden = Pylon2_MK80s_restrictions },
        ...
        pylon(14, 0, -0.155000, -0.343000, 2.944000, { arg = 322, arg_value = 0, connector = "Pylon18", use_full_connector_position = true, DisplayName	= "8", droppable_shape	= "f-15E_Pylon_8", },
            {
				...
				{   CLSID =  "{D8F2C90B-887B-4B9E-9FE2-996BC9E9AF03}", Type = 1, forbidden = Pylon14_MK80s_restrictions },
				{   CLSID =  "{B06DD79A-F21E-4EB9-BD9D-AB3844618C9C}", Type = 1, forbidden = Pylon14_MK80s_restrictions },
	...
	Failures = {
		--{ id = 'AAQ13_FLIR_SENSOR_FAIL',		label = _('AN/AAQ13 FLIR sensor fail'),	enable = false, hh = 0, mm = 0, mmint = 1, prob = 100 },
		{ id = 'AAQ13_TF_RADAR_SENSOR_FAIL',	label = _('AN/AAQ13 TF radar fail'),	enable = false, hh = 0, mm = 0, mmint = 1, prob = 100 },
		{ id = 'CARA_RADALT_FAIL',				label = _('CARA Radar Altimeter fail'),	enable = false, hh = 0, mm = 0, mmint = 1, prob = 100 },
	},
	...
	AddPropAircraft = {
   		{ id = "iff_Label", control = 'label', label = _('IFF'), xLbl = 150, playerOnly = true},
		{ id = "IFF_M2_CODE" , control = 'editbox', label = _('IFF Mode 2 code'), getDefault = getIFFM2, onChange = onChange_IFFM2, onFocus = onFocus_IFFM2, playerOnly = true},
    
   		{ id = "misc_Label", control = 'label', label = _('MISCELLANEOUS'), xLbl = 150, playerOnly = true},
